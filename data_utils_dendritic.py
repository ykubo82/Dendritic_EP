...
def createHyperparametersFile(path, args, model, command_line):
    ...
    L = ["- task: {}".format(args.task) + "\n",
        ...
        "- basal branches (DMLP): {}".format(getattr(args, 'basal_branches', 'n/a')) + "\n",
        "- apical branches (DMLP): {}".format(getattr(args, 'apical_branches', 'n/a')) + "\n",
        "- branch sparsity (DMLP): {}".format(getattr(args, 'branch_sparsity', 'n/a')) + "\n",
        "- apical scale (DMLP): {}".format(getattr(args, 'apical_scale', 'n/a')) + "\n",
